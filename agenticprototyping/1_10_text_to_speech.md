...
Here is an example of `alloy`:
<audio controls>
  <source src="images/openai-fm-alloy-calm.mp3" type="audio/mpeg">
</audio>
...
1.  The [model](https://platform.openai.com/docs/api-reference/audio/createSpeech) you're using
2.  The [text](https://platform.openai.com/docs/api-reference/audio/createSpeech) to be turned into audio
3.  The [voice](https://platform.openai.com/docs/api-reference/audio/createSpeech) that will speak the output
